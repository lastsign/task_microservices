...
openssl req -nodes -newkey rsa:4096 -keyout client.key -out client.csr -subj /CN=user_service
openssl req -nodes -newkey rsa:4096 -keyout server.key -out server.csr -subj /CN=api_service
